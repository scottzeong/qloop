...
const evaluationDimensions = [
  {
    ...
    description: "개념을 정확하게 이해하고 올바르게 설명하는 능력",
    rubrics: {
  ...
  },
  {
    name: "reasoning",
    displayName: "논리적 설명",
    description: "논리적이고 체계적으로 사고를 전개하는 능력",
    rubrics: {
  ...
  },
  {
    name: "evidence",
    displayName: "근거 제시",
    description: "주장을 뒷받침하는 구체적 근거를 제시하는 능력",
    rubrics: {
  ...
  },
  {
    name: "clarity",
    displayName: "표현의 명확성",
    description: "생각을 명확하고 이해하기 쉽게 표현하는 능력",
    rubrics: {
  ...
  },
  {
    name: "depth",
    displayName: "사고의 깊이",
    description: "표면적 이해를 넘어 깊이 있게 사고하는 능력",
    rubrics: {
  ...
  },
  {
    ...
    description: "학습한 개념을 실제 상황에 적용하는 능력",
    rubrics: {
